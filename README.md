...
Using API
get all books - GET /book to get a list of all the books
get specific book - GET /book?=${bookname} to get a specific book
create book - POST JSON to /books to create a new book
